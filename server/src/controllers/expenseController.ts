...
import { z } from 'zod';
import { Expense, IParticipant } from '../models/Expense';
...
const createExpenseSchema = z.object({
  ...
  amount: z.number().positive('Amount must be positive'), // Amount passed in INR or paise; server converts float INR to paise integer
...
export const createExpense = async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    ...
    let calculatedParticipants: IParticipant[] = [];
